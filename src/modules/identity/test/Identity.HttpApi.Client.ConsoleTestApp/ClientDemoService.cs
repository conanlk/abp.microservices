...
public class ClientDemoService : ITransientDependency
{
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        //Get access token using ABP IIdentityModelAuthenticationService
    ...
    private async Task TestAllManuallyAsync()
    {
        ...
        var disco = await client.GetDiscoveryDocumentAsync(_configuration["IdentityClients:Default:Authority"] ?? string.Empty);
        if (disco.IsError)
        {
